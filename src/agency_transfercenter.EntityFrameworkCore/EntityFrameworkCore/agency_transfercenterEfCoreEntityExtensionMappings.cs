...
public static class agency_transfercenterEfCoreEntityExtensionMappings
{
  ...
  public static void Configure()
  {
    ...
    OneTimeRunner.Run(() =>
    {
       ...
       * USE agency_transfercenterModuleExtensionConfigurator CLASS (in the Domain.Shared project)
